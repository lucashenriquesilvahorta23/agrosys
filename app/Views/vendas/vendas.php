        ...
        <div class="row">
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <h2 style="text-align: center; color: #000; font-weight: 400;" >Quantidade de vendas </h2>
                                <div id="chartdiv"></div>
                            </div>
                        </div>
                                    ...
                                    <?php 
                                        if ($resultados != "") {
                                            foreach ($resultados as $resultado) {
                                                ...
                                                echo '		<a href="/Vendas/Detalhes/'.base64_encode($resultado->id_procedimento_venda).'" >';
...
var chart = am4core.create("chartdiv", am4charts.XYChart);
  ...
  $.ajax({
    type: "POST",
    url: '/Vendas/getQuantidadeAnimaisPorProcedimento',
    data: {
    },
    dataType: 'json',
