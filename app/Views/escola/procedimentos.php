<div class="content-wrapper" style="margin-left: 300px">
    <section class="content-header">
        <h1>
            <i class="fa fa-globe"></i> Procedimentos
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                                    ...
                                    <?php 
                                        if ($resultados != "") {
                                            foreach ($resultados as $resultado) {
                                                echo '<tr>';
                                                echo '  <td>' . htmlspecialchars($resultado->animal) . '</td>';
                                                echo '  <td>' . htmlspecialchars($resultado->identificador) . '</td>';
                                                echo '  <td>' . htmlspecialchars($resultado->peso) . ' Kg</td>';
                                                echo '  <td>' . htmlspecialchars($resultado->vacinas) . '</td>';
                                                echo '  <td>' . htmlspecialchars($resultado->medicamentos) . '</td>';
                                                echo '  <td>' . nl2br(htmlspecialchars($resultado->observacoes)) . '</td>';
                                                echo '</tr>';
                                            }
                                        }
                                    ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h2 style="text-align: center; color: #000; font-weight: 400;" >Quantidade de vacinas aplicadas </h2>
                                <div id="chartdiv"></div>
                            </div>
                            <div class="col-md-6">
                                <h2 style="text-align: center; color: #000; font-weight: 400;" >Quantidade de medicamentos aplicados </h2>
...
<!--                         <div class="row">
                            <div class="col-md-12">
                                <h2 style="text-align: center; color: #000" >Animais por peso </h2>
